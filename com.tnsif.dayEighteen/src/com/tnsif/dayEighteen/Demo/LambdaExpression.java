...
public class LambdaExpression {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sorting in decending order: " + list);
		
		//Lambda Expression to sort in decending order
		Comparator<Integer> comp = (n1,n2) -> n2 - n1;
		Collections.sort(list,comp);
		System.out.println("Sorting in decending order using lambda Expression " + list);
		...
		// Collection.sort(studentList);  //CTE
		System.out.println("------------------------------");
		...
		System.out.println("--------------------------------");
		comp1 = (str1,str2) -> str1.getname().compareTo(str2.getname());
		Collections.sort(studentList,comp1);
